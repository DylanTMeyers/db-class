...
for(var i=0; i< campgrounds.length; i++) {
    ...
    res.json({name:`${Obj.name}`, town: `${Obj.town}`,lengthLimit: Obj.lengthLimit ,elevation: Obj.elevation,numberOfSites: Obj.numberOfSites,padType: `${Obj.padType}`});
});
...
app.get('/elevation', (req, res) => {
	var results= [];
	let searchAlt = req.query.altitude;
